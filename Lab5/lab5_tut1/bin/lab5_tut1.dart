...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'Nam',
    'Ra'
  ]; //This is same as , final desserts = const['Aditya','Nam','Ra'];
  ...
  */
  ...
  // Challenge 1:
  String para =
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ut, aperiam reprehenderit. Fugiat ea in repellat modi minus id voluptate laudantium ad, cupiditate sint quia amet impedit distinctio pariatur odio soluta? Possimus eaque eos amet distinctio. Explicabo eos incidunt distinctio voluptas velit dolorem corrupti? Accusantium rem blanditiis, labore minus cumque rerum facere enim corporis quae fuga consequatur quia nemo quisquam, asperiores at laudantium eveniet commodi doloribus eaque amet deleniti totam? Dolorum, illum quod. Magnam ipsam temporibus sapiente, sunt sint ratione aperiam? Libero labore ratione incidunt debitis quis, dicta neque et animi placeat suscipit nemo officia illo praesentium minus explicabo nostrum dolores?";
  ...
  // Challenge 3:
  User user1 = User(1, 'Aditya');
  User user2 = User(2, 'Kaneriya');
